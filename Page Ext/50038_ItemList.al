pageextension 50038 itemlist extends "Item List"
{
    layout
    {
        modify(Description)
    ...
    actions
    {
        ...
        addafter("&Item Availability by")
        {
            group("Update Data")
            {
                action("Update price & Margin")
                {
                    Promoted = true;
                    ApplicationArea = All;
                    RunObject = xmlport "Updateprice&margin";
                    trigger OnAction()
                    begin
                ...
                action("Update price Category & Allocation")
                {
                    Promoted = true;
                    ApplicationArea = All;
                    RunObject = xmlport "PriceCat&AllocationType";
                    trigger OnAction()
                    begin
