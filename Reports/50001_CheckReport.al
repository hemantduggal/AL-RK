report 50001 CheckPrint
{
    DefaultLayout = RDLC;
    RDLCLayout = 'ReportLayout/ChequePrint.rdl';
    Caption = 'CheckPrint';
...
*/
                ...
                begin
                    if not TestPrint then begin
                        ...
                        if ApplyMethod <> ApplyMethod::MoreLinesOneEntry then begin
                            ...
                            //GenJnlLine3.TestField("Posting No. Series", ''); // TRI AKUL
                            // GenJnlLine3."Document No." := UseCheckNo;  // TRI AKUL
                            //    GenJnlLine3."Cheque No." := UseCheckNo; // TRI AKUL
                            //  GenJnlLine3."Cheque Date" := GenJnlLine3."Posting Date";  // TRI AKUL
            ...
            begin
                ...
                TestField("Document No."); // TRI AKUL
                ...
                if not TestPrint then begin
                    ...
                    if ("Account No." <> '') and ("Bal. Account No." <> '') then begin
                        //  BalancingType := Rec."Account Type";
    ...
    //S.M
    procedure FormatNoText1(VAR NoText: ARRAY[2] OF Text[120]; No: Decimal; CurrencyCode: Code[10])
    var
        PrintExponent: Boolean;
        Ones: Integer;
        Tens: Integer;
    ...
    begin
        ...
        END ELSE begin
            ...
            //            Message('Check%1..%2', NoText[1], NoTextIndex);
            //PrintExponent := true;
            AddToNoText(NoText, NoTextIndex, PrintExponent, 'PAISA ONLY');
        END;
    END;
    ...
    procedure AddToNoText(VAR NoText: ARRAY[2] OF Text[120]; VAR NoTextIndex: Integer; VAR PrintExponent: Boolean; AddText: Text[30])
    begin
        PrintExponent := TRUE;
        ...
        END;
        //   NoText[NoTextIndex] := NoText[NoTextIndex] + ' ' + AddText;
        // Message('%1', NoText[NoTextIndex]);
    ...
    begin
        ...
        //      AddText := GLPost.SentenceCase(AddText);//PBS SOOR
        NoText[NoTextIndex] := DelChr(NoText[NoTextIndex] + ' ' + AddText, '<');
    end;
