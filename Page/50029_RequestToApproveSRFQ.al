page 50029 "Requset To Approve Sales RFQ"
{
    PageType = List;
    ...
    begin
        ...
        BrandMaster.Reset();
        BrandMaster.SetRange("User Id", UserId);
        BrandMaster.SetRange(BrandMaster."Approver 1", true);
        if not BrandMaster.FindFirst() then
            Error('User ID does not tag on brand master');
        /*
    BrandMaster.Reset();
    BrandMaster.SetRange("User Id", UserId);
    BrandMaster.SetRange("Approver 1", true);
