page 50048 "FAE Lines Approval Request"
{
    ApplicationArea = All;
    PageType = List;
    SourceTable = "FAE Line";
    SourceTableView = where("FAE Line Approval Status" = filter("Pending For Approval"));
            ...
            action(Approve)
            {
                ...
                begin
                    ...
                    if Rec."FAE Line Approval Status" = Rec."FAE Line Approval Status"::"Pending For Approval" then
                        Rec."FAE Line Approval Status" := Rec."FAE Line Approval Status"::Approved;
                    Rec.Modify();
                END;
            }
