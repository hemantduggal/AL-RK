...
page 50066 "Item JN Tracking"
{
    SourceTable = "Item Journal Tracking";
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    ...
    var
        ...
        SaleLine: Record "Item Journal Line";
    ...
    var
        BarcodeTr: Record "Item Journal Tracking";
        transhead: Record "Transfer Line";
        SaleLine: Record "Item Journal Line";
        IJL: Record "Item Journal Line";
        PurLineLine: Record "Purchase Line";
    begin
        ...
        SaleLine.Reset();
        SaleLine.SetRange("Document No.", Rec."Document No.");
        SaleLine.SetRange(SaleLine."Item No.", Rec."Item No.");
        SaleLine.SetRange("Line No.", Rec."Item Line No.");
        if SaleLine.FindFirst() then begin
            Rec."Location Code" := SaleLine."Location Code";
            Rec."Entry Type" := Rec."Entry Type"::"Item Journal Line";
    ...
    var
        ...
        ProductBarTracking: Record "Item Journal Tracking";
        POtrack: Decimal;
        Cartontrc: Decimal;
        proBarTrc: Decimal;
        POQty: Decimal;
        POLine: Record "Purchase Line";
        SOLine: Record "Item Journal Line";
        TransLine: Record "Item Journal Line";
    ...
    begin
        ...
        ProductBarTracking.SetRange(ProductBarTracking."Item Line No.", Rec."Line No.");
        ...
        SOLine.SetRange(SOLine."Item No.", Rec."Item No.");
