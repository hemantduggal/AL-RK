...
page 50062 "TO Barcode Tracking"
{

    SourceTable = "TO Tracking";
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    ...
    var
        BarcodeTr: Record "TO Tracking";
        transhead: Record "Transfer Line";
        SaleLine: Record "Transfer Line";
        IJL: Record "Item Journal Line";
        PurLineLine: Record "Purchase Line";
    begin
        BarcodeTr.Reset();
        ...
        SaleLine.SetRange("Line No.", Rec."Item Line No.");
        if SaleLine.FindFirst() then begin
            Rec."Location Code" := SaleLine."Transfer-from Code";
            Rec."Entry Type" := Rec."Entry Type"::Transfer;
        end;
    end;
