page 50038 "SaleslineAllocationApprovalReq"
{
    Caption = 'Sales line Allocation Approval Request';
    PageType = List;
    SourceTable = "Sales Line";
    SourceTableView = where("Allocation Status" = filter("Pending For Approval"));
    ApplicationArea = All;
    UsageCategory = Lists;
    Editable = true;
    layout
