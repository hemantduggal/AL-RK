page 50033 "Margin Status ApprovalRequests"
{
    PageType = List;
    SourceTable = "Sales RFQ Line";
    SourceTableView = where("Margin Less Status" = filter("Pending For Approval"));
    ApplicationArea = All;
    UsageCategory = Lists;
    Editable = true;
    layout
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(SendApprovalRequest)
            {
                ...
                var
                begin
                    Rec."Margin Less Status" := Rec."Margin Less Status"::Approved;
                    Rec.Modify();
                END;
            }
            ...
            action(Reject)
            {
                ...
                begin
                    ...
                    Rec."Margin Less Status" := Rec."Margin Less Status"::Open;
                    Rec.Modify();
                end;
            }
