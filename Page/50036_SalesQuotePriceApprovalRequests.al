page 50036 "SalesQuotePriceApproval"
{
    Caption = 'Sales Quote Price Approval Requests';
    PageType = List;
    SourceTable = "Sales Line";
    SourceTableView = where("Price Status" = filter("Pending For Approval"), "Document Type" = filter(Quote));
    ApplicationArea = All;
    UsageCategory = Lists;
    Editable = true;
    layout
