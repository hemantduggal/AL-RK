page 50039 "SaleslineApprovalReq"
{
    Caption = 'Sales Lines Approval Request';
    PageType = List;
    SourceTable = "Sales Line";
    SourceTableView = where("Line Approval Status" = filter("Pending For Approval"));
    ApplicationArea = All;
    UsageCategory = Lists;
    Editable = true;
    layout
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(SendApprovalRequest)
            {
                ...
                var
                begin
                    Rec."Line Approval Status" := Rec."Line Approval Status"::Approved;
                    Rec.Modify();
                END;
            }
